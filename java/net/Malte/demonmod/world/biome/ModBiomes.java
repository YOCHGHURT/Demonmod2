...
public class ModBiomes {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, DemonMod.MOD_ID);

    public static final RegistryObject<Biome> DEMOINC_BIOME = BIOMES.register("demonic_biome",
            () -> makeDemonicBiome(() -> ModConfiguredSurfaceBuilders.DEMONIC_SURFACE, 0.125f, 0.05f));

    private static Biome makeDemonicBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
