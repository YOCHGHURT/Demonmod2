package net.Malte.demonmod.world.structure;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import net.Malte.demonmod.DemonMod;
import net.Malte.demonmod.world.structure.structures.DemonTowerStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, DemonMod.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> DEMONTOWER =
            STRUCTURES.register("demontower", DemonTowerStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(DEMONTOWER.get(),
